...
class OnboardingRouteScreenshotTest {
    @Test
    fun firstStop() =
        captureDesktopScreenshot("src/test/screenshots-desktop/onboarding-route-first.png") {
            NavigoTheme(disableDynamicTheming = true) {
                OnboardingRouteBackground(0f, Modifier.fillMaxSize())
            }
        }
}
