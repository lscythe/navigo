...
class HomeNearbyStopsSheetScreenshotTest {
    @Test fun collapsed() = capture("collapsed", NearbyStopsSheetValue.Collapsed)

    @Test fun halfExpanded() = capture("half-expanded", NearbyStopsSheetValue.HalfExpanded)

    @Test fun expanded() = capture("expanded", NearbyStopsSheetValue.Expanded)

    private fun capture(name: String, value: NearbyStopsSheetValue) =
        captureDesktopScreenshot("src/test/screenshots-desktop/home-nearby-stops-$name.png") {
