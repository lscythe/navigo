...
import dev.lscythe.app.navigo.feature.home.impl.generated.resources.feature_home_impl_maptoolkit_logo_description
...
internal fun HomeMap() {
    val camera =
        rememberCameraState(
            firstPosition =
                CameraPosition(
                    target = Position(HomeMapLongitude, HomeMapLatitude),
                    zoom = HomeMapZoom,
                )
        )

    MaplibreMap(
        baseStyle = BaseStyle.Uri(homeMapStyleUri(isSystemInDarkTheme())),
        cameraState = camera,
                ...
                Row(
                    ...
                    ExpandingAttributionButton(
                        ...
                        expandedContent = { _, textStyle ->
                            AttributionLinks(
                                attributions = listOf(HomeMapAttributionHtml),
                                textStyle = textStyle,
...
private fun MaptoolkitLogo(
    ...
    contentDescription: String? =
        stringResource(Res.string.feature_home_impl_maptoolkit_logo_description),
    onClick: (() -> Unit)? = rememberOpenWebsite(HomeMaptoolkitUrl),
) {
    Image(
        painter = painterResource(Res.drawable.feature_home_impl_img_maptoolkit),
