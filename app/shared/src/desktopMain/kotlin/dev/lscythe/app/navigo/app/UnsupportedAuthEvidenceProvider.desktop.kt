...
@BindingContainer
object DesktopAuthProviderBindings {
    @Provides
    fun provideAuthEvidenceProvider(): AuthEvidenceProvider = UnsupportedAuthEvidenceProvider
}

private object UnsupportedAuthEvidenceProvider : AuthEvidenceProvider {
