...
dependencies {
    ...
    stagingGoogleImplementation(libs.axer)
    stagingHuaweiImplementation(libs.axer)
    betaGoogleImplementation(libs.axer)
    betaHuaweiImplementation(libs.axer)
    rcGoogleImplementation(libs.axer)
    rcHuaweiImplementation(libs.axer)
    prodGoogleImplementation(libs.axer.no.op)
    prodHuaweiImplementation(libs.axer.no.op)
