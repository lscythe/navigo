...
object AuthProviderBindings {
    @Provides
    fun provideAuthEvidenceProvider(
        enrollmentDataSource: AttestationEnrollmentDataSource
    ): AuthEvidenceProvider =
        AndroidKeyAttestationProvider(
            PersistentAttestationEnrollmentStore(enrollmentDataSource),
            PlatformAndroidAttestationKeyStore(),
        )
}
