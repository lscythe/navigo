...
/**
 * Retrieves [PerformanceMetricsState.Holder] from current [LocalView] and remembers it until the
 * View changes.
 *
...
/**
 * Convenience function to work with [PerformanceMetricsState] state. The side effect is re-launched
 * if any of the [keys] value is not equal to the previous composition.
 *
 ...
 * The side effect is re-launched if any of the [keys] value is not equal to the previous
 * composition.
 */
@Composable
