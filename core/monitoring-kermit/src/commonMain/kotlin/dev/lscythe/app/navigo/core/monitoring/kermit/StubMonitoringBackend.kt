...
class StubMonitoringBackend : MonitoringBackend {
    override val crashReporter: CrashReporter = StubCrashReporter()
    override val appLogger: AppLogger = KermitAppLogger()
    override val tracer: Tracer = StubTracer()

    override fun initialize(config: MonitoringConfig) = Unit
}
