...
val NavigoIcons.SocketDisconnected: ImageVector
    get() {
        if (_SocketDisconnected != null) {
            return _SocketDisconnected!!
        }
        _SocketDisconnected =
            ImageVector.Builder(
...
@Suppress("ObjectPropertyName") private var _SocketDisconnected: ImageVector? = null
