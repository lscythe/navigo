...
interface AuthEvidenceProvider {
    val provider: AuthProvider

    suspend fun needsEnrollment(): Boolean

    suspend fun createEnrollmentEvidence(challenge: AuthChallenge): AuthResult<EnrollmentEvidence>

    suspend fun enrollmentCreated(enrollmentId: String)

    suspend fun enrollmentRevoked()

    suspend fun createSessionEvidence(challenge: AuthChallenge): AuthResult<SessionEvidence>
}
